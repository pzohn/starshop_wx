...
Page({
  data: {
    ...
    DFrames: {
      layOut: [
        { imgUrl: "https://www.gfcamps.cn/morningstar/yxlx.png", text: "研学旅行", route: "../indexdetail/indexdetail?id=15" },
        { imgUrl: "https://www.gfcamps.cn/morningstar/shsj.png", text: "社会实践", route: "../indexdetail/indexdetail?id=16" },
